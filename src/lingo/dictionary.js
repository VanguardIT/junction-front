export default {
  ...
  files: {
    "../app/layout.tsx": {
      entries: {
        "7/declaration/body/0/argument/1/1/1/openingElement/0/value/expression":
          {
            content: {
              ar: "جاري التحميل...",
              en: "Loading...",
        ...
        "7/declaration/body/0/argument/1/1/openingElement/0/value/expression": {
          content: {
            ar: "جاري التحميل...",
            en: "Loading...",
            fr: "Chargement...",
        ...
        "8/declaration/body/0/argument/1/1/openingElement/0/value/expression": {
          content: {
            ar: "جاري التحميل...",
            en: "Loading...",
            fr: "Chargement...",
    ...
    "app/dashboard/page.tsx": {
      entries: {
        ...
        "4/declaration/body/0/argument/1/5/1/5/1": {
          content: {
            ar: "نظرة عامة",
            en: "Overview",
            fr: "Aperçu",
        ...
        "4/declaration/body/0/argument/3/1/1/1/3": {
          content: {
            ar: "إجمالي المستخدمين",
            en: "Total Users",
            fr: "Utilisateurs totaux",
        ...
        "4/declaration/body/0/argument/3/1/1/3": {
          content: {
            ar: "1,234",
            en: "1,234",
            fr: "1 234",
          },
          hash: "7c208818dde8b59b40985edf13909d47",
        },
        "4/declaration/body/0/argument/3/1/1/5": {
          content: {
            ar: "+12% مقارنة بالشهر الماضي",
            en: "+12% from last month",
            fr: "+12 % par rapport au mois dernier",
        ...
        "4/declaration/body/0/argument/3/1/3/1/3": {
          content: {
            ar: "الإيرادات",
            en: "Revenue",
            fr: "Revenus",
        ...
        "4/declaration/body/0/argument/3/1/3/3": {
          content: {
            ar: "$45,231",
            en: "$45,231",
            fr: "45 231 €",
          },
          hash: "52019eb21a12200fd8bb17c98afad03a",
        },
        "4/declaration/body/0/argument/3/1/3/5": {
          content: {
            ar: "+20% مقارنة بالشهر الماضي",
            en: "+20% from last month",
            fr: "+20 % par rapport au mois dernier",
        ...
        "4/declaration/body/0/argument/3/1/5/1/3": {
          content: {
            ar: "المشاريع النشطة",
            en: "Active Projects",
            fr: "Projets actifs",
        ...
        "4/declaration/body/0/argument/3/1/5/3": {
          content: {
            ar: "12",
            en: "12",
            fr: "12",
          },
          hash: "d877598cb4fab5944dfbc84151a0f231",
        },
        "4/declaration/body/0/argument/3/1/5/5": {
          content: {
            ar: "+2 مقارنة بالأسبوع الماضي",
            en: "+2 from last week",
            fr: "+2 par rapport à la semaine dernière",
        ...
        "4/declaration/body/0/argument/3/1/7/1/3": {
          content: {
            ar: "المهام المعلقة",
            en: "Pending Tasks",
            fr: "Tâches en attente",
        ...
        "4/declaration/body/0/argument/3/1/7/3": {
          content: {
            ar: "89",
            en: "89",
            fr: "89",
        ...
        "4/declaration/body/0/argument/3/1/7/5": {
          content: {
            ar: "-5 مقارنة بالأمس",
            en: "-5 from yesterday",
            fr: "-5 par rapport à hier",
        ...
        "4/declaration/body/0/argument/3/3/1/3/1/expression/0/body/3/1": {
          content: {
            ar: "النشاط <expression/>",
            en: "Activity <expression/>",
            fr: "Activité <expression/>",
        ...
        "4/declaration/body/0/argument/3/3/1/3/1/expression/0/body/3/3": {
          content: {
            ar: "هذا وصف نشاط توضيحي",
            en: "This is a sample activity description",
            fr: "Ceci est un exemple de description d'activité",
        ...
        "4/declaration/body/0/argument/3/3/1/3/1/expression/0/body/5": {
          content: {
            ar: "منذ <expression/>ساعة",
            en: "<expression/>h ago",
            fr: "Il y a <expression/>h",
        ...
        "4/declaration/body/0/argument/3/3/3/1": {
          content: {
            ar: "إجراءات سريعة",
            en: "Quick Actions",
            fr: "Actions rapides",
        ...
        "4/declaration/body/0/argument/3/3/3/3/1": {
          content: {
            ar: "إنشاء مشروع جديد",
            en: "Create New Project",
            fr: "Créer un nouveau projet",
        ...
        "4/declaration/body/0/argument/3/3/3/3/3": {
          content: {
            ar: "إضافة مستخدم",
            en: "Add User",
            fr: "Ajouter un utilisateur",
        ...
        "4/declaration/body/0/argument/3/3/3/3/5": {
          content: {
            ar: "إنشاء تقرير",
            en: "Generate Report",
            fr: "Générer un rapport",
    ...
    "components/app-sidebar.tsx": {
      entries: {
        "6/declaration/body/1/argument/1/1/1/1/1/3/1": {
          content: {
            ar: "تطبيقي",
            en: "My App",
            fr: "Mon application",
          },
          hash: "972598469bf28a28203b84af0ea8e309",
        },
        "6/declaration/body/1/argument/1/1/1/1/1/3/3": {
          content: {
            ar: "لوحة التحكم",
            en: "Dashboard",
            fr: "Tableau de bord",
        ...
        "7/declaration/body/1/argument/1/3/1/1/1/3/1": {
          content: {
            ar: "FishTer",
            en: "FishTer",
            fr: "FishTer",
        ...
        "7/declaration/body/1/argument/1/3/1/1/1/3/3": {
          content: {
            ar: "لوحة التحكم",
            en: "Dashboard",
            fr: "Tableau de bord",
    ...
    "components/nav-user.tsx": {
      entries: {
        "4/declaration/body/1/argument/1/1/1/1/1/3": {
          content: {
            ar: "CN",
            en: "CN",
            fr: "CN",
          },
          hash: "5796507f657484613eca22e099326c84",
        },
        "4/declaration/body/1/argument/1/1/3/1/1/1/3": {
          content: {
            ar: "CN",
            en: "CN",
            fr: "CN",
        ...
        "4/declaration/body/1/argument/1/1/3/5/1": {
          content: {
            ar: "<element:BadgeCheck></element:BadgeCheck> الحساب",
            en: "<element:BadgeCheck></element:BadgeCheck> Account",
            fr: "<element:BadgeCheck></element:BadgeCheck> Compte",
          },
          hash: "659a069cebe95f1dfbab0723a1cac64b",
        },
        "4/declaration/body/1/argument/1/1/3/5/3": {
          content: {
            ar: "<element:Bell></element:Bell> الإشعارات",
            en: "<element:Bell></element:Bell> Notifications",
            fr: "<element:Bell></element:Bell> Notifications",
          },
          hash: "b7cd3fd88b25e32d5036805eb352bfb0",
        },
        "4/declaration/body/1/argument/1/1/3/9": {
          content: {
            ar: "<element:LogOut></element:LogOut> تسجيل الخروج",
    ...
    "components/ui/shadcn/breadcrumb.tsx": {
      entries: {
    ...
    "components/ui/shadcn/sheet.tsx": {
      entries: {
